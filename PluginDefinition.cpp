...
, m_initResources(1)
{
    ...
    m_parameters.push_back(Parameter("time", -1.0, 1.0, 0.0));
    m_parameters.push_back(Parameter("frequency", 0.0, 32.0, 4.0));
    m_parameters.push_back(Parameter("layer1", 0.0, 1.0, 1.0));
    m_parameters.push_back(Parameter("layer2", 0.0, 1.0, 0.0));
    m_parameters.push_back(Parameter("layer4", 0.0, 1.0, 0.0));
    m_parameters.push_back(Parameter("layer8", 0.0, 1.0, 0.0));
